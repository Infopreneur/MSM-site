    ...
    <SiteShell>
      <main className="bg-white">
        <section className="bg-slate-950 py-16 text-white sm:py-20">
          <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[1fr_0.92fr] lg:px-8">
            <div className="max-w-2xl">
              <Badge className="rounded-full bg-emerald-500/15 px-4 py-1.5 text-emerald-300 hover:bg-emerald-500/15">
            ...
            <div className="rounded-[2rem] bg-white p-3 text-slate-900 shadow-[0_24px_80px_rgba(0,0,0,0.18)]">
              <LeadForm
                variant="webinar"
                title="Register Now"
        ...
        <section className="bg-slate-50 py-16 sm:py-20">
          <div className="mx-auto grid max-w-7xl gap-8 px-4 sm:px-6 lg:grid-cols-[1.1fr_0.9fr] lg:px-8">
            <div className="rounded-[2rem] border border-slate-200 bg-white p-8 shadow-[0_18px_50px_rgba(15,23,42,0.06)]">
              ...
              <div className="mt-6 flex min-h-[280px] items-center justify-center rounded-[1.75rem] bg-slate-950 p-8 text-center text-white">
                <div>
                  ...
                  <p className="mt-3 max-w-md text-sm leading-7 text-slate-300">
                    This visual block can be swapped for your webinar embed or short intro video while preserving the high-converting structure.
                  </p>
                </div>
              </div>
            </div>
