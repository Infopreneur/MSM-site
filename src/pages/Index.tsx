import { ArrowRight, BadgeCheck, CalendarDays, ChevronRight, CircleDollarSign, LaptopMinimal, MessageSquareText, ShieldCheck, Users, Workflow } from "lucide-react";
      ...
      <main className="bg-white">
        <section className="pt-8 sm:pt-12">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="rounded-[2rem] border border-slate-200 bg-white px-6 py-8 shadow-sm sm:px-8 sm:py-10 lg:px-12 lg:py-14">
              <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
                <div className="max-w-2xl">
                  ...
                  <h1 className="mt-6 text-4xl font-semibold leading-tight tracking-tight text-slate-950 sm:text-5xl lg:text-6xl">
                    ...
                    <span className="mt-2 block">Build a High-Income Business With Modern Tools</span>
                  </h1>
                ...
                <div className="grid gap-4 rounded-[2rem] border border-slate-200 bg-slate-50 p-4 sm:p-5">
                  <div className="rounded-[1.75rem] bg-slate-950 p-6 text-white">
                    ...
                    <div className="mt-7 grid grid-cols-3 gap-3">
                      {[
                        ...
                        <div key={label} className="rounded-[1.25rem] bg-white/5 p-4">
                  ...
                  <div className="grid gap-4 lg:grid-cols-2">
                    ...
                    <div className="rounded-[1.75rem] bg-emerald-500 p-5 text-white">
                      ...
                      <div className="mt-6 rounded-[1.5rem] bg-white/15 p-4">
                        <div className="flex items-center gap-3">
        ...
        <section className="py-16 sm:py-20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-8 flex flex-col gap-4 rounded-[1.75rem] bg-slate-950 px-6 py-5 text-white sm:flex-row sm:items-center sm:justify-between">
              <div>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-10 grid gap-5 lg:grid-cols-3">
              {testimonials.map((item, index) => (
                <Card key={item.name} className={`rounded-[2rem] border ${index === 1 ? "border-emerald-200 bg-emerald-50/50" : "border-slate-200 bg-white"} shadow-sm`}>
              ...
              <div className="rounded-[2rem] bg-slate-950 p-8 text-white">
                ...
                <div className="mt-8 space-y-4">
                  {candidateTypes.map((item) => (
                    <div key={item} className="flex items-center gap-3 rounded-[1.5rem] bg-white/5 px-4 py-4 text-slate-100">
        ...
        <section className="pb-16 sm:pb-20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="rounded-[2rem] bg-emerald-500 px-6 py-8 text-white sm:px-8 sm:py-10 lg:flex lg:items-center lg:justify-between">
              <div className="max-w-2xl">
